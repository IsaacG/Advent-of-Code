...
class Day15(aoc.Challenge):
    ...
    def solver(self, puzzle_input: InputType, param: bool) -> int:
        ...
        sizes = [i[1] for i in puzzle_input]
        ...
        return method(puzzle_input)

    def smart_solver(self, puzzle_input: InputType) -> int:
        ...
        disks = sorted(
            ...
            for number, positions, _, start in puzzle_input
        )
        start_time = 0
        step = 1
        while disks:
    ...
    def brute_force(self, puzzle_input: InputType) -> int:
