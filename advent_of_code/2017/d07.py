...
def solve(data: list[list[int | str]], part: int) -> int | str:
    """Return information about the balanced towers."""
    ...
    weight: int
    children: list[str]
    for (node, weight, *children) in data:  # type: ignore
...
PARSER = aoc.parse_re_findall_mixed(r"\d+|[a-z]+")
SAMPLE = """\
pbga (66)
xhth (57)
ebii (61)
