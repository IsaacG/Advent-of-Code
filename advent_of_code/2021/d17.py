#!/bin/python
"""Advent of Code: Day 17. Determine what initial velocities will allow the probe to hit the target."""
...
def solve(data: list[list[int]], part: int) -> int:
    """Compute velocity information which allows hitting the target."""
    x0, x1, y0, y1 = data[0]
    ...
    if part == 1:
        ...
        y_max = max(y for x, y in velocities)
...
TESTS = [(1, SAMPLE, 45), (2, SAMPLE, 112)]
