...
def fft(signal: list[int], offset: int) -> list[int]:
    """Compute the FFT.
...
TESTS = [
    (1, "80871224585914546619083218645595", 24176176),
    (1, "19617804207202209144916044189917", 73745418),
    (1, "69317163492948606335995924319873", 52432133),
    (2, "03036732577212944063491565474664", 84462026),
    (2, "02935109699940807407585447034323", 78725270),
    (2, "03081770884921959731165446850517", 53553731),
]
